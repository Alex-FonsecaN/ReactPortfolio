...
export const MainContextProvider = ({ children }) => {
    ...
    const texts = [
        ...
        "Gosto de explorar outras áreas, uma delas sendo a criação de filtros para TikTok. Já criei e publiquei diversos filtros, praticando minha criatividade e cultivando isso como um hobby pessoal."
    ];
